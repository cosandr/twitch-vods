...
if __name__ == "__main__":
    ...
    try:
        # loop.run_until_complete(run_cmd(cmd, logger))
        loop.run_until_complete(run_exec('ffmpeg', args_stream, logger))
        # loop.run_until_complete(run_exec('streamlink', args_streamlink, logger))
