...
# ffmpeg -i raw/RichardLewisReports_20-09_17-10-2018_Return_Of_By_The_Numbers_51.flv -err_detect ignore_err -f mp4 -acodec aac -c copy -y -v info -hide_banner ../vods/RichardLewisReports_20-09_17-10-2018_Return_Of_By_The_Numbers_51.mp4
        ...
        # Valid response
            ...
            if len(r_dict['data']) != 0:
                if (r_dict['data'][0]['type'] == 'live'):
                    ...
                    self.start_time = datetime.datetime.now().strftime("%H-%M_%d-%m-%Y")
                    self.record()
            else:
